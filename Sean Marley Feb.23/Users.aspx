<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Users.aspx.cs" Inherits="WebPages_Users" %>
...
<html>
    ...
    <div>      
        <asp:GridView ID="GridView1" CssClass="w3-red" runat="server" AutoGenerateColumns="False" CellPadding="3" OnRowCancelingEdit="GridView1_RowCancelingEdit"   
  
OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellSpacing="1" GridLines="None" Visible="False">  
            <Columns>  
                <asp:TemplateField>  
                    <ItemTemplate>  
                    ...
                    <EditItemTemplate>  
                        <asp:Button ID="btn_Update" runat="server" Text="Update" CommandName="Update" CausesValidation="false"/>  
                ...
                <asp:TemplateField HeaderText="Email">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_firstName" runat="server" Text='<%#Eval("Email") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
            ...
            <HeaderStyle BackColor="red" Font-Bold="True" ForeColor="#E7E7FF" />
        ...
        <table class="auto-style61">
            <tr>
                <td class="auto-style62">&nbsp;<asp:Button ID="Button1" runat="server" Text="Submit New User" Width="160px" OnClick="Submit_Click" ValidationGroup="ButtonGroup" />
                    <asp:Label ID="SuccessLabel" runat="server" ForeColor="Red"></asp:Label>
                </td>
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="EditButton" runat="server" Text="Edit Users" Width="160px" CausesValidation="False" OnClick="EditButton_Click" ValidationGroup="ButtonGroup" />
                </td>
            </tr>
            <tr>
